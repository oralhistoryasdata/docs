...
Because Oral History as Data is built on top of CollectionBuilder-CSV, you have access to many powerful customization options beyond the OHD-specific features.

{% include bootstrap/alert.md text="**Note**: OHD is built on **CollectionBuilder-CSV**, so follow instructions related to that specific template." color="info" %}

{% include button.html link="https://collectionbuilder.github.io/cb-docs/" text="View the CollectionBuilder Docs" color="primary btn-lg mt-2 mb-4" %}
