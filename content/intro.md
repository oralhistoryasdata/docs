...
- Transform interview transcripts into structured CSV files and code them 
- Create a metadata CSV spreadsheet
...
The entire process is designed to be flexible, allowing you to focus on the content and analysis rather than web development. (However, the code is all yours and you customize away as well if you'd like!)
